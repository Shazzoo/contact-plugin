...
<select class="cf-input" id="{{ $id }}" name="{{ $inputName }}" @if (!empty($field['required'])) required @endif>
    <option value="">{{ $field['placeholder'] ?? __('contact-form::messages.form.choose') }}</option>
